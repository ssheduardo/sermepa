...
class TpvTest extends PHPUnitTestCase
{
    ...
    public function when_set_all_parameters_should_obtain_all_ds_merchant_valid()
    {
        ...
        $redsys->setEnvironment('test')
            ...
            ->setCurrency(\Redsys\Merchant\MerchantCurrencies::EUR)
            ->setTransactiontype(\Redsys\Merchant\MerchantTransactionTypes::AUTORIZACION)
            ->setTerminal('1')
            ->setMethod(\Redsys\Merchant\MerchantPaymethods::TARJETA)
            ->setNotification('')
